...
**Облачная среда** - это экземпляр установленной системы на базе кода OpenStack. 
Это сложная система, состоящая из множества компонентов, поэтому при каждом действии 
важно понимать, какой точно будет результат.
...
Развёртывание облачной среды на базе дистрибутива Asperitas производится с использованием утилиты **Asperitas Console**.
