...
htmlhelp_basename = 'asperitasdoc'
...
latex_documents = [
    (master_doc, 'Asperitas.tex', 'Asperitas Documentation',
     'ИСП РАН', 'manual'),
]
...
man_pages = [
    (master_doc, 'asperitas', 'Asperitas Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Asperitas', 'Asperitas Documentation',
     author, 'Asperitas', 'One line description of project.',
     'Miscellaneous'),
]
